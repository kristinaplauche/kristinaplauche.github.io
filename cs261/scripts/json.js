...
forecast.open('GET', 'https://api.wunderground.com/api/cdf3f3537bf94c1c/forecast/q/GA/Kennesaw.json', true);
forecast.send();
...
var myObject = { name: "Kristina", position: "mother", city: "Kennesaw" };
var myJSON = JSON.stringify(myObject);
document.getElementById("myObject").innerHTML = myJSON;
